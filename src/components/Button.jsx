 ...
 */
const SecondaryButton = ({width, onPress, title, touchableOpacityProps = {}, textProps = {}, linearGradientProps = {}}) => {
 ...
 * @param {SolidBtnProps} props
 */
const PrimaryButton = ({width, onPress, title, touchableOpacityProps = {}, textProps = {}, linearGradientProps = {}}) => {
 const theme = useTheme()
 ...
 */
const OutlinedButton = ({color: propColor = "", onPress, title, touchableOpacityProps = {}, textProps = {}}) => {
 const theme = useTheme()
  ...
  return (
    ...
    <View
      style={{
        ...
        <Text
          style={{color, fontSize: 16, fontWeight: '500'}}
          >
          {title}
        </Text>
