...
marginBottom:20
      ...
      <View style={{flex: 1,justifyContent:'space-around',paddingHorizontal:8}}>
        <Text style={{fontFamily:'Satoshi-Medium',color:'#262B2E',fontSize:18}}>{item.name}</Text>
        <View style={{flexDirection:'row',alignItems:'center'}}>
        ...
        <View style={{flexDirection:'row',alignItems:'center'}}>
            ...
            <View style={[styles.menuContainer,{backgroundColor:'rgba(255,188,0,0.2)'}]}>
                <Text style={{
                    color:'#402B8C',
                    fontFamily:'Satoshi-Regular',
                    fontSize:12
            ...
            <View style={[styles.menuContainer,{backgroundColor:'rgba(29,191,115,0.2)'}]}>
                <Text style={{
                    color:'#00C1FF',
                    fontFamily:'Satoshi-Regular',
                    fontSize:12
